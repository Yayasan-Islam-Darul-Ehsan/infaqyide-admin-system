...
const initialDarkMode = () => {
  const item = window.sessionStorage.getItem("darkMode");
  return item ? JSON.parse(item) : themeConfig.layout.darkMode;
};

const initialSidebarCollapsed = () => {
  const item = window.sessionStorage.getItem("sidebarCollapsed");
  return item ? JSON.parse(item) : themeConfig.layout.menu.isCollapsed;
};

const initialSemiDarkMode = () => {
  const item = window.sessionStorage.getItem("semiDarkMode");
...
const initialType = () => {
  const item = window.sessionStorage.getItem("type");
  return item ? JSON.parse(item) : themeConfig.layout.type;
};

const initialMonochrome = () => {
  const item = window.sessionStorage.getItem("monochrome");
...
export const layoutSlice = createSlice({
  ...
  reducers: {
    ...
    handleDarkMode: (state, action) => {
      ...
      window.sessionStorage.setItem("darkMode", action.payload);
    },
    // handle sidebar collapsed
    handleSidebarCollapsed: (state, action) => {
      state.isCollapsed = action.payload;
      window.sessionStorage.setItem("sidebarCollapsed", action.payload);
    },
    // handle customizer
    ...
    handleSemiDarkMode: (state, action) => {
      ...
      window.sessionStorage.setItem("semiDarkMode", action.payload);
    },
    // handle rtl
    ...
    handleType: (state, action) => {
      ...
      window.sessionStorage.setItem("type", JSON.stringify(action.payload));
    },
    // handle menu hidden
    ...
    handleMonoChrome: (state, action) => {
      ...
      window.sessionStorage.setItem("monochrome", JSON.stringify(action.payload));
    },
  },
});
