...
KutipanTetap.propTypes = {
    
};

function KutipanTetap(props) {
    ...
    const [transaction, set_transaction]            = useState([
        {
            transaction_id: 1,
            transaction_invoice: `INQ09019290819287234`,
            transaction_datetime: moment().format("DD MMM YYYY, hh:mm A"),
            transaction_amount: 100.00,
            transaction_status: 'Approve',
            transaction_name: 'Infaq - Sumbangan untuk Anak Yatim ' + moment().subtract(1, 'days').format("DD MMM YYYY"),
            transaction_type: 'Kredit'
        },
        {
            transaction_id: 2,
            transaction_invoice: `WKF090192909128812333`,
            transaction_datetime: moment().format("DD MMM YYYY, hh:mm A"),
            transaction_amount: 150.00,
            transaction_status: 'Approve',
            transaction_name: 'Waqaf - Pembelian Tanah Waqaf ' + moment().subtract(2, 'days').format("DD MMM YYYY"),
            transaction_type: 'Kredit'
        },
        {
            transaction_id: 3,
            transaction_invoice: `SMB090112918289372373`,
            transaction_datetime: moment().format("DD MMM YYYY, hh:mm A"),
            transaction_amount: 200.00,
            transaction_status: 'Approve',
            transaction_name: 'Sumbangan - Bantuan Banjir ' + moment().subtract(3, 'days').format("DD MMM YYYY"),
            transaction_type: 'Kredit'
        },
        {
            transaction_id: 4,
            transaction_invoice: `KMP090100029392883455`,
            transaction_datetime: moment().format("DD MMM YYYY, hh:mm A"),
            transaction_amount: 250.00,
            transaction_status: 'Approve',
            transaction_name: 'Kempen - Derma Ramadan ' + moment().subtract(4, 'days').format("DD MMM YYYY"),
            transaction_type: 'Kredit'
        },
        {
            transaction_id: 5,
            transaction_invoice: `INQ0998182877290192490`,
            transaction_datetime: moment().format("DD MMM YYYY, hh:mm A"),
            transaction_amount: 300.00,
            transaction_status: 'Approve',
            transaction_name: 'Infaq - Pembinaan Masjid ' + moment().subtract(5, 'days').format("DD MMM YYYY"),
            transaction_type: 'Kredit'
        },
        {
            transaction_id: 6,
            transaction_invoice: `WKF090128371298347823`,
            transaction_datetime: moment().format("DD MMM YYYY, hh:mm A"),
            transaction_amount: 350.00,
            transaction_status: 'Approve',
            transaction_name: 'Waqaf - Waqaf Al-Quran ' + moment().subtract(6, 'days').format("DD MMM YYYY"),
            transaction_type: 'Kredit'
        },
        {
            transaction_id: 7,
            transaction_invoice: `SMB090238472918273645`,
            transaction_datetime: moment().format("DD MMM YYYY, hh:mm A"),
            transaction_amount: 400.00,
            transaction_status: 'Approve',
            transaction_name: 'Sumbangan - Pembangunan Sekolah ' + moment().subtract(7, 'days').format("DD MMM YYYY"),
            transaction_type: 'Kredit'
        },
        {
            transaction_id: 8,
            transaction_invoice: `KMP090374829372918273`,
            transaction_datetime: moment().format("DD MMM YYYY, hh:mm A"),
            transaction_amount: 450.00,
            transaction_status: 'Approve',
            transaction_name: 'Kempen - Bantuan COVID-19 ' + moment().subtract(8, 'days').format("DD MMM YYYY"),
            transaction_type: 'Kredit'
        },
        {
            transaction_id: 9,
            transaction_invoice: `INQ090918273645092873`,
            transaction_datetime: moment().format("DD MMM YYYY, hh:mm A"),
            transaction_amount: 500.00,
            transaction_status: 'Approve',
            transaction_name: 'Infaq - Bantuan Pelajar Miskin ' + moment().subtract(9, 'days').format("DD MMM YYYY"),
            transaction_type: 'Kredit'
        },
        {
            transaction_id: 10,
            transaction_invoice: `WKF090374828273645192`,
            transaction_datetime: moment().format("DD MMM YYYY, hh:mm A"),
            transaction_amount: 550.00,
            transaction_status: 'Approve',
            transaction_name: 'Waqaf - Pembelian Buku ' + moment().subtract(10, 'days').format("DD MMM YYYY"),
            transaction_type: 'Kredit'
        },
        {
            transaction_id: 11,
            transaction_invoice: `SMB090182918273645018`,
            transaction_datetime: moment().format("DD MMM YYYY, hh:mm A"),
            transaction_amount: 600.00,
            transaction_status: 'Approve',
            transaction_name: 'Sumbangan - Pembinaan Klinik ' + moment().subtract(11, 'days').format("DD MMM YYYY"),
            transaction_type: 'Kredit'
        },
        {
            transaction_id: 12,
            transaction_invoice: `KMP090298376298374645`,
            transaction_datetime: moment().format("DD MMM YYYY, hh:mm A"),
            transaction_amount: 650.00,
            transaction_status: 'Approve',
            transaction_name: 'Kempen - Program Makanan Percuma ' + moment().subtract(12, 'days').format("DD MMM YYYY"),
            transaction_type: 'Kredit'
        },
        {
            transaction_id: 13,
            transaction_invoice: `INQ090928374820938471`,
            transaction_datetime: moment().format("DD MMM YYYY, hh:mm A"),
            transaction_amount: 700.00,
            transaction_status: 'Approve',
            transaction_name: 'Infaq - Bantuan Keperluan Asas ' + moment().subtract(13, 'days').format("DD MMM YYYY"),
            transaction_type: 'Kredit'
        },
        {
            transaction_id: 14,
            transaction_invoice: `WKF090293847109283740`,
            transaction_datetime: moment().format("DD MMM YYYY, hh:mm A"),
            transaction_amount: 750.00,
            transaction_status: 'Approve',
            transaction_name: 'Waqaf - Waqaf Pembelian Kenderaan ' + moment().subtract(14, 'days').format("DD MMM YYYY"),
            transaction_type: 'Kredit'
        },
        {
            transaction_id: 15,
            transaction_invoice: `SMB090283746598347109`,
            transaction_datetime: moment().format("DD MMM YYYY, hh:mm A"),
            transaction_amount: 800.00,
            transaction_status: 'Approve',
            transaction_name: 'Sumbangan - Bantuan Musim Sejuk ' + moment().subtract(15, 'days').format("DD MMM YYYY"),
            transaction_type: 'Kredit'
        },
        {
            transaction_id: 16,
            transaction_invoice: `KMP090238471029384718`,
            transaction_datetime: moment().format("DD MMM YYYY, hh:mm A"),
            transaction_amount: 850.00,
            transaction_status: 'Approve',
            transaction_name: 'Kempen - Bantuan Kemanusiaan ' + moment().subtract(16, 'days').format("DD MMM YYYY"),
            transaction_type: 'Kredit'
        },
        {
            transaction_id: 17,
            transaction_invoice: `INQ090109238471092384`,
            transaction_datetime: moment().format("DD MMM YYYY, hh:mm A"),
            transaction_amount: 900.00,
            transaction_status: 'Approve',
            transaction_name: 'Infaq - Sumbangan Pembelian Ubat ' + moment().subtract(17, 'days').format("DD MMM YYYY"),
            transaction_type: 'Kredit'
        },
        {
            transaction_id: 18,
            transaction_invoice: `WKF090092384719283471`,
            transaction_datetime: moment().format("DD MMM YYYY, hh:mm A"),
            transaction_amount: 950.00,
            transaction_status: 'Approve',
            transaction_name: 'Waqaf - Pembangunan Perpustakaan ' + moment().subtract(18, 'days').format("DD MMM YYYY"),
            transaction_type: 'Kredit'
        },
        {
            transaction_id: 19,
            transaction_invoice: `SMB090109238472910238`,
            transaction_datetime: moment().format("DD MMM YYYY, hh:mm A"),
            transaction_amount: 1000.00,
            transaction_status: 'Approve',
            transaction_name: 'Sumbangan - Program Kebajikan ' + moment().subtract(19, 'days').format("DD MMM YYYY"),
            transaction_type: 'Kredit'
        },
        {
            transaction_id: 20,
            transaction_invoice: `KMP090928347109283745`,
            transaction_datetime: moment().format("DD MMM YYYY, hh:mm A"),
            transaction_amount: 1050.00,
            transaction_status: 'Approve',
            transaction_name: 'Kempen - Bantuan Kecemasan ' + moment().subtract(20, 'days').format("DD MMM YYYY"),
            transaction_type: 'Kredit'
        }
    ])
        ...
        <div>
            ...
            <section>
                <div className='flex flex-row justify-between items-center gap-4'>
                    <div>
                        <p className={`font-semibold text-gray-900 ${width <= breakpoints.md ? 'text-sm' : 'text-2xl'}`}>Kutipan Tetap - (Tabung Masjid)</p>  
                        <p className={`text-sm text-gray-500`}>Berikut adalah maklumat mengenai kutipan tetap anda sepanjang tahun.</p>  
                    </div>
                ...
                <div className='grid grid-cols-1 md:grid-cols-4 gap-3'>
                    <div className='col-span-2 bg-white p-6 border border-gray-200 rounded-xl'>
                        <div className='flex flex-row gap-3'>
                            ...
                            <div className='pl-3'>
                                <p className='text-sm text-gray-500'>Jumlah Kutipan Tetap Keseluruhan</p>
                                <p className='font-semibold text-2xl text-gray-900'>RM {parseFloat(2134.50).toFixed(2)}</p>
                    ...
                    <div className='col-span-1 bg-white p-6 border border-gray-200 rounded-xl'>
                        <div className='pl-3'>
                            <p className='text-sm text-gray-500'>Jumlah Kutipan Tetap {moment().format("MMMM YYYY")}</p>
                            <p className='font-semibold text-2xl text-gray-900'>RM {parseFloat(1135.90).toFixed(2)}</p>
                            <p className='mt-1 font-normal text-xs text-gray-400'>*Baki diatas merujuk kepada bulan {moment().format("MMMM YYYY")}.</p>
                        </div>
                    </div>
                    <div className='col-span-1 bg-white p-6 border border-gray-200 rounded-xl'>
                        <div className='pl-3'>
                            <p className='text-sm text-gray-500'>Jumlah Kutipan Tetap {moment().subtract(1, 'month').format("MMMM YYYY")}</p>
                            <p className='font-semibold text-2xl text-gray-900'>RM {parseFloat(2134.50 - 1135.90).toFixed(2)}</p>
