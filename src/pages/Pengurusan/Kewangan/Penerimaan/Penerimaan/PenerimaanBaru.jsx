...
PenerimaanBaru.propTypes = {
    
};

function PenerimaanBaru(props) {
    ...
    return (
        <div>
            ...
            <Modal
            title='Penambahan Maklumat Penerimaan Dana'
            ...
            <section>
                <div className='flex flex-row justify-between items-center gap-4'>
                    <div>
                        <p className={`font-semibold text-gray-900 ${width <= breakpoints.md ? 'text-sm' : 'text-2xl'}`}>Penerimaan Dana - (Sumbangan Kepada Masjid)</p>  
                        <p className={`text-sm text-gray-500`}>Berikut adalah maklumat mengenai penerimaan dana oleh institusi anda sepanjang tahun.</p>  
                    </div>
                ...
                <div className='grid grid-cols-1 md:grid-cols-4 gap-3'>
                    <div className='col-span-2 bg-white p-6 border border-gray-200 rounded-xl'>
                        <div className='flex flex-row gap-3'>
                            ...
                            <div className='pl-3'>
                                <p className='text-sm text-gray-500'>Jumlah Penerimaan Dana Keseluruhan</p>
                    ...
                    <div className='col-span-1 bg-white p-6 border border-gray-200 rounded-xl'>
                        <div className='pl-3'>
                            <p className='text-sm text-gray-500'>Jumlah Penerimaan Dana {moment().format("MMMM YYYY")}</p>
                    ...
                    <div className='col-span-1 bg-white p-6 border border-gray-200 rounded-xl'>
                        <div className='pl-3'>
                            <p className='text-sm text-gray-500'>Jumlah Penerimaan {moment().subtract(1, 'month').format("MMMM YYYY")}</p>
                                ...
                                loading === false && (
                                    <>
                                        ...
                                        <thead className="bg-slate-200 dark:bg-slate-700 p-3 rounded-md">
                                            ...
                                            <td width={'20%'} className='p-3 font-semibold text-xs'>Butiran Penerimaan Dana</td>
