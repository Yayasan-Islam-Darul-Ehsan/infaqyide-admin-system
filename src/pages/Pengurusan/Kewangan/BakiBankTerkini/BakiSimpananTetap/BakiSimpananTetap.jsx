...
BakiSimpananTetap.propTypes = {
    
};

function BakiSimpananTetap(props) {
    ...
    const [bank_balance, set_bank_balance]          = useState(1039.55)
    const [transaction, set_transaction]            = useState([
        ...
        {
            transaction_id: 6,
            transaction_invoice: `AJ090128371298347823`,
            transaction_datetime: moment().format("DD MMM YYYY, hh:mm A"),
            transaction_amount: 75.00,
            transaction_status: 'Approve',
            transaction_name: 'Deposit Dari Kerja Sebanyak RM 75.00',
            transaction_type: 'Kredit'
        },
        {
            transaction_id: 7,
            transaction_invoice: `AJ090238472918273645`,
            transaction_datetime: moment().format("DD MMM YYYY, hh:mm A"),
            transaction_amount: 200.00,
            transaction_status: 'Approve',
            transaction_name: 'Deposit Dari Kerja Sebanyak RM 200.00',
            transaction_type: 'Kredit'
        },
        {
            transaction_id: 8,
            transaction_invoice: `AJ090374829372918273`,
            transaction_datetime: moment().format("DD MMM YYYY, hh:mm A"),
            transaction_amount: 350.00,
            transaction_status: 'Cancel',
            transaction_name: 'Deposit Dari Kerja Sebanyak RM 350.00',
            transaction_type: 'Kredit'
        },
        {
            transaction_id: 9,
            transaction_invoice: `AJ090918273645092873`,
            transaction_datetime: moment().format("DD MMM YYYY, hh:mm A"),
            transaction_amount: 500.00,
            transaction_status: 'Approve',
            transaction_name: 'Sumbangan Ke Tabung Infaq Am Sebanyak RM 500.00',
            transaction_type: 'Debit'
        },
        {
            transaction_id: 10,
            transaction_invoice: `AJ090374828273645192`,
            transaction_datetime: moment().format("DD MMM YYYY, hh:mm A"),
            transaction_amount: 600.00,
            transaction_status: 'Cancel',
            transaction_name: 'Deposit Dari Kerja Sebanyak RM 600.00',
            transaction_type: 'Kredit'
        }
    ]
    )
    ...
    useEffect(() => {
        setTotalRows(transaction.length)
    }, [])
        ...
        <div>
            <section>
                <div className='flex flex-row justify-between items-center gap-4'>
                    <div>
                        <p className={`font-semibold text-gray-900 ${width <= breakpoints.md ? 'text-sm' : 'text-2xl'}`}>Maklumat Baki Bank Simpanan Tetap</p>  
                        <p className={`text-sm text-gray-500`}>Berikut adalah maklumat mengenai baki bank simpanan tetap dan juga senarai transaksi anda.</p>  
                    </div>
...
export default BakiSimpananTetap;