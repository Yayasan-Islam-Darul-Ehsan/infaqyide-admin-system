...
TambahBankSimpananTetap.propTypes = {
    
};

function TambahBankSimpananTetap(props) {
    ...
    const CREATE__FIXED__DEPOSIT__BANK = async () => {
        close_modal()
        if(!bank_name || bank_name === "" || bank_name === undefined || bank_name === null) {
            ...
            let api = await API("kewangan/bank-simpanan-tetap/tambah-akaun", json, "POST", true)
            console.log("Log Api Tambah Bank Simpanan Tetap : ", api)
    ...
    return (
        <div>
            <Modal
            title='Pengesahan Menambah Akaun Bank Simpanan Tetap'
            ...
            footerContent={(
                ...
                <div className='flex justify-end items-center gap-3'>
                    ...
                    <Button className='bg-teal-600 text-white' onClick={CREATE__FIXED__DEPOSIT__BANK}>Ya</Button>
                </div>
                </>
            )}
            >
                <p className='font-normal text-sm text-gray-600'>Anda pasti untuk menambah rekod akaun bank simpanan tetap?</p>
            </Modal>

            <section>
                <div className='flex flex-row justify-between items-center gap-4'>
                    <div>
                        <p className={`font-semibold text-gray-900 ${width <= breakpoints.md ? 'text-sm' : 'text-2xl'}`}>Tambah Akaun Bank Simpanan Tetap</p>  
            ...
            <section className='mt-6'>
                <Card>
                    <div>
                        <p className='font-semibold text-gray-900 text-lg'>Borang Akaun Bank Simpanan Tetap</p>
                        <p className='font-normal text-gray-600 text-sm'>Sila lengkapkan maklumat bank simpanan tetap anda di bawah.</p>
                    </div>
                    <div className='mt-6'>
                        <div>
                            <Select 
            ...
            <section className='mt-3'>
                <div className='flex justify-end items-center'>
                    <Button className='bg-teal-600 text-white' onClick={open_modal}>Tambah Bank Simpanan Tetap</Button>
                </div>
            </section>
        </div>
    );
...
export default TambahBankSimpananTetap;