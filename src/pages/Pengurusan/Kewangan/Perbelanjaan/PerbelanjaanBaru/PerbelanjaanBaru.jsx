...
PerbelanjaanBaru.propTypes = {
    
};

function PerbelanjaanBaru(props) {
    ...
    const [transaction, set_transaction]    = useState([
        {
            "id": 1,
            "invoice_number": "UTIL001",
            "bill_name": "Electricity Bill",
            "bill_description": "Monthly electricity bill for the mosque",
            "transaction_type": "Expenditure",
            "transaction_amount": 1200,
            "transaction_date_time": "2024-07-01T09:30:00",
            "payment_method": "Bank Transfer",
            "payor_name": "Masjid Utilities Dept.",
            "payor_email": "utilities@masjid.com",
            "payor_phone": "+60123456780",
            "debit_credit": "Debit"
        },
        {
            "id": 2,
            "invoice_number": "UTIL002",
            "bill_name": "Water Bill",
            "bill_description": "Monthly water bill for the mosque",
            "transaction_type": "Expenditure",
            ...
            "payor_name": "Masjid Utilities Dept.",
            "payor_email": "utilities@masjid.com",
            "payor_phone": "+60123456781",
            "debit_credit": "Debit"
        },
        {
            "id": 3,
            "invoice_number": "UTIL003",
            "bill_name": "Internet Service",
            "bill_description": "Monthly fee for internet service",
            "transaction_type": "Expenditure",
            ...
            "payor_phone": "+60123456782",
            "debit_credit": "Debit"
        },
        {
            "id": 4,
            "invoice_number": "UTIL004",
            "bill_name": "Gas Bill",
            "bill_description": "Monthly gas bill for the mosque kitchen",
            "transaction_type": "Expenditure",
            "transaction_amount": 350,
            "transaction_date_time": "2024-07-04T12:30:00",
            "payment_method": "Cheque",
            "payor_name": "Masjid Utilities Dept.",
            "payor_email": "utilities@masjid.com",
            "payor_phone": "+60123456783",
            "debit_credit": "Debit"
        },
        {
            "id": 5,
            "invoice_number": "UTIL005",
            "bill_name": "Waste Management",
            "bill_description": "Monthly waste management service",
            "transaction_type": "Expenditure",
            "transaction_amount": 500,
            "transaction_date_time": "2024-07-05T13:00:00",
            "payment_method": "Bank Transfer",
            "payor_name": "Masjid Facilities Dept.",
            "payor_email": "facilities@masjid.com",
            "payor_phone": "+60123456784",
            "debit_credit": "Debit"
        },
        {
            "id": 6,
            "invoice_number": "UTIL006",
            "bill_name": "Air Conditioning Service",
            "bill_description": "Quarterly service for air conditioning units",
            "transaction_type": "Expenditure",
            "transaction_amount": 800,
            "transaction_date_time": "2024-07-06T14:00:00",
            "payment_method": "Credit Card",
            "payor_name": "Masjid Maintenance Dept.",
            "payor_email": "maintenance@masjid.com",
            "payor_phone": "+60123456785",
            "debit_credit": "Debit"
        },
        {
            "id": 7,
            "invoice_number": "UTIL007",
            "bill_name": "Telephone Bill",
            "bill_description": "Monthly telephone bill for the mosque office",
            "transaction_type": "Expenditure",
            ...
            "payor_phone": "+60123456786",
            "debit_credit": "Debit"
        },
        {
            "id": 8,
            "invoice_number": "UTIL008",
            "bill_name": "Water Cooler Maintenance",
            "bill_description": "Annual maintenance for water coolers",
            "transaction_type": "Expenditure",
            ...
            "payor_name": "Masjid Facilities Dept.",
            "payor_email": "facilities@masjid.com",
            "payor_phone": "+60123456787",
            "debit_credit": "Debit"
        },
        {
            "id": 9,
            "invoice_number": "UTIL009",
            "bill_name": "Backup Generator Fuel",
            "bill_description": "Fuel costs for backup generator",
            "transaction_type": "Expenditure",
            ...
            "payor_name": "Masjid Maintenance Dept.",
            "payor_email": "maintenance@masjid.com",
            "payor_phone": "+60123456788",
            "debit_credit": "Debit"
        },
        {
            "id": 10,
            "invoice_number": "UTIL010",
            "bill_name": "Heating System Service",
            "bill_description": "Annual service for heating system",
            "transaction_type": "Expenditure",
        ...
        <div>
            ...
            <section>
                <div className='flex flex-row justify-between items-center gap-4'>
                    <div>
                        <p className={`font-semibold text-gray-900 ${width <= breakpoints.md ? 'text-sm' : 'text-2xl'}`}>Perbelanjaan Baru</p>  
                        <p className={`text-sm text-gray-500`}>Berikut adalah maklumat mengenai perbelanjaan baru yang dibuat oleh institusi anda sepanjang tahun.</p>  
                    </div>
...
export default PerbelanjaanBaru;