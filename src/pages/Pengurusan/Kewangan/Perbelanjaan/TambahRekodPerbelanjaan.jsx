...
TambahRekodPerbelanjaan.propTypes = {
    
};

function TambahRekodPerbelanjaan(props) {
    ...
    const [trans_mode, set_trans_mode]                                          = useState("Credit")
    ...
    return (
        <div>
            ...
            >
                <p className='font-normal text-sm text-gray-600'>Anda pasti untuk menambah rekod transaksi perbelanjaan ini?</p>
            </Modal>

            <section>
                <div className='flex flex-row justify-between items-center gap-4'>
                    <div>
                        <p className={`font-semibold text-gray-900 ${width <= breakpoints.md ? 'text-sm' : 'text-2xl'}`}>Tambah Rekod Pengeluaran / Perbelanjaan</p>  
                        <p className={`text-sm text-gray-500`}>Sila lengkapkan maklumat pengeluaran atau perbelanjaan anda.</p>  
                    </div>
                </div>
            </section>
                            ...
                            <Card>
                                ...
                                <div className='mt-3'>
                                    ...
                                    <div className='mt-3 grid grild-cols-1 md:grid-cols-1 gap-3'>
                                        ...
                                        placeholder='Contoh: Pembayaran Bil Utiliti Masjid'
                                    ...
                                    <div className='mt-3 grid grild-cols-1 md:grid-cols-1 gap-3'>
                                        ...
                                        placeholder='Contoh: Keterangan Maklumat Mengenai Pembayaran Bil Utiliti Masjid Sebanyak RM1,000.00'
...
export default TambahRekodPerbelanjaan;