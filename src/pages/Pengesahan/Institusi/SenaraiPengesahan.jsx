...
KomenPengesahanInstitusi.propTypes = {
    
};

function KomenPengesahanInstitusi(props) {
    ...
    const getData = async () => {
        set_loading(true)
        try {
            let api = await API(`v2/pengesahan/institusi?page=${setting.page}&limit=${setting.limit}`, {}, "GET", true)
    ...
    return (
        <div>
            ...
            <section>
                <HomeBredCurbs title={"Senarai Komen Pengesahan Akaun"} />
            </section>

            <section className='mt-6'>
                <Card 
                    title={"Komen Pengesahan"}
                    subtitle={"Berikut adalah senarai komen pengesahan akaun anda. Klik senarai di bawah untuk melihat keterangan lanjut."}
...
export default KomenPengesahanInstitusi;