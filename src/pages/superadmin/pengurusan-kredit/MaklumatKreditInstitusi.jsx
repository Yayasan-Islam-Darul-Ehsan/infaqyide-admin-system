...
function MaklumatKreditInstitusi(props) {
    ...
    const [akaun_id, set_akaun_id]  = useState(state.organizationWalletId || null)
    ...
    const getTransaction = async () => {
        set_loading2(true)
        try {
            let api = await SYSADMIN_API(`pengurusan/kredit/institusi/${akaun_id}/transaction?page=${page}&limit=${limit}`, {}, "GET", true)   
            if(api.status_code === 200) {
